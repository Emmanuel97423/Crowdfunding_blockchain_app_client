...
const Icon = ({isActive, styles, name, imgUrl, disabled, handleClick} : IconProps) =>{
    return(
  ...
  return (
    <div className="flex justify-between flex-col items-center sticky top-5 h-[93vh]">
      ...
      <div className="flex-1 flex flex-col justify-between items-center bg-[#c1c1c24] rounded-[20px] w-[76px] py-4 mt-12">
        ...
        <Icon styles="bg-[1c1c24] shadow-secondary" imgUrl={sun} isActive={undefined} name={undefined} disabled={undefined} handleClick={undefined}/>
      </div>
    </div>
  )
}
